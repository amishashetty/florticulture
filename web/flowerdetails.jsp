        ...
        <div class="container py-5">
                        ...
                        <div class="card-header bg-primary text-center p-4">
                            ...
                            <div class="card-body rounded-bottom bg-white">
                                <table border="1" width="100%">
                                    <tr style="background: #7F8181;color: #ffffff"><th>Name</th><th>Photo</th><th>Soil & Growth</th><th>Weather & Temperature</th><th>Disease & Fertilizer</th><th>How to Grow</th><th>Uses</th><th></th></tr>
                         <%
                             try  {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(res.next())
            {
                ...
                String diseases=res.getString("diseases");
                ...
                String grow=res.getString("grow");
                String photo="images/"+res.getString("photo");
                
                out.println("<tr><td>"+name+"("+scientificname+")</td><td><img src='"+photo+"' style=\"width:100px;\"></td><td>Soil:<br> "+soil+"<br><br>Growth:<br> "+growth+"<br></td><td>Weather:<br> "+weather+"<br><br>Temperature:<br> "+temperature+"</td><td>Diseases: <br>"+diseases+"<br><br>Fertilizers: <br>"+fertilizer+"<td>"+grow+"</td><td>"+uses+"</td><td><a href='addprice.jsp?id="+id+"'><img src='img/rs.png' style=\"width:25px;\"></a></td></tr>");
