...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="expertsystem.jsp" class="nav-item nav-link active">Expert system</a>
    ...
    <div class="container-fluid bg-registration py-5" style="margin: 90px 0;">
        <div class="container py-5">
                ...
                <div class="col-lg-5">
                    <div class="card border-0">
                        <div class="card-header bg-primary text-center p-4">
                            <h1 class="text-white m-0">Expert System</h1>
                        </div>
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    Temperature:
                                    <input type="text" name="temperature" class="form-control p-4" placeholder="Enter Temperature" required/>
                                </div>
                                    <div class="form-group">
                                    soil:
                                    <input type="text" name="soil" class="form-control p-4" placeholder="Enter soil" required/>
                                </div>
                                
                                <div>
                                    <input class="btn btn-primary btn-block py-3" type="submit" name="search" value="SEARCH"/>
                                </div>
                            </form>
                    </div>
                </div>
                        ...
                        <div class="card-header bg-primary text-center p-4">
                            ...
                            <div class="card-body rounded-bottom bg-white">
                                <table border="1" width="100%">
                                    <tr style="background: #7F8181;color: #ffffff"><th>flowers</th></tr>
                         <%
                             try  {
            ...
            ResultSet res=sta.executeQuery("SELECT * FROM `flowers` WHERE temperature like '%"+temperature+"' and soil like '%"+soil+"%' and weather='"+weather+"'");
            int slno=0;
            while(res.next())
            {
                                 String flowers=res.getString("name");
                                 
                out.println("<tr><td>"+flowers+"</td></tr>");
