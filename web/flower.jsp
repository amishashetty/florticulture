                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form action="addflower" method="POST">
                                ...
                                <div class="form-group">
                                    Diseases:
                                    <input type="text" name="diseases" class="form-control p-4" placeholder="Enter Diseases" required/>
                                </div>
                                <div class="form-group">
                                    Growth Duration:
                                ...
                                How To Grow:
                                    <input type="text" name="grow" class="form-control p-4" placeholder="how to grow flower" required/>
                                </div>
                                <div>
