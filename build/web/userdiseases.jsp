            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="userdiseases.jsp" class="nav-item nav-link active">Diseases List</a>
        ...
        <div class="container py-5">
                        ...
                        <div class="card-header bg-primary text-center p-4">
                            ...
                            <div class="card-body rounded-bottom bg-white">
                                <table border="1" width="100%">
                                    <tr style="background: #7F8181;color: #ffffff"><th>Name</th><th>Photo</th><th>Solution</th></tr>
                         <%
                             try  {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(res.next())
            {
                ...
                out.println("<tr><td>"+name+"</td><td><img src='"+photo+"' style=\"width:100px;\"></td><td>Solution: "+solution+"</td></tr>");
