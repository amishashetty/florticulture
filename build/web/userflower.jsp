            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="userflower.jsp" class="nav-item nav-link active">Flowers List</a>
                        ...
                        <a href="userrequests.jsp" class="nav-item nav-link">Add Requests</a>
        ...
        <div class="container py-5">
                        ...
                        <div class="card-header bg-primary text-center p-4">
                            ...
                            <div class="card-body rounded-bottom bg-white">
                                <table border="1" width="100%">
                                    <tr style="background: #7F8181;color: #ffffff"><th>Name</th><th>Photo</th><th>Soil and Growth<br></th><th>Weather & temperature</th><th>Diseases & Fertilizer</th><th>How To Grow</th><th>Uses</th><th></th></tr>
                         <%
                             try  {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(res.next())
            {
                ...
                out.println("<tr><td>"+name+"("+scientificname+")</td><td><img src='"+photo+"' style=\"width:100px;\"></td><td>Soil: "+soil+"<br><br>Growth Duration: <br>"+growth+"<br></td><td>Weather: "+weather+"<br><br>Temperature: "+temperature+"</td><td>diseases: "+diseases+"<br><br>Fertilizers: "+fertilizer+"<td>"+grow+"</td><td>"+uses+"</td><td><a href='viewprice.jsp?id="+id+"'><img src='img/rs.png' style=\"width:25px;\"></a></td></tr>");
