            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="updates.jsp" class="nav-item nav-link active active">Add Updates</a>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="card border-0">
                        <div class="card-header bg-primary text-center p-4">
                            <h1 class="text-white m-0">Add Updates</h1>
                        </div>
                ...
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="card border-0">
                        <div class="card-header bg-primary text-center p-4">
                            <h1 class="text-white m-0">News list</h1>
                            <div class="card-body rounded-bottom bg-white">
                                <table border="1" width="100%">
                                    <tr style="background: #7F8181;color: #ffffff"><th>Subject</th><th>News</th><th></th></tr>
                         <%
                             try  {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            ResultSet res=sta.executeQuery("SELECT * FROM `update`");
            int slno=0;
            while(res.next())
            {
                ...
                out.println("<tr><td>"+subject+"</td><td>"+description+"</td><td><img src='img/deleteicon.jpg' style=\"width:25px;\" onclick='Delupdates("+id+")'></td></tr>");
...
<script>
    function Delupdates(id)
      {
          var txt;
          var r=confirm("Do you really want to Delete Updates?");
          if(r==true)
          {
              window.location.replace("delupdates?id="+id+"");
          }
          else
          {
