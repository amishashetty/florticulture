     ...
     String id=request.getParameter("id");
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(res1.next())
            {
                ...
                out.println("<p>Subject: "+subject+"<br>Description: "+description+"<br>Farmer Name: "+farmername+"<br>Phone Number: "+farmerid+"</p>");
            ...
            out.println(e);
                             ...
                             %>
                       <form action="addreplay?id=<%out.println(id);%>" method="POST">
                                <div class="form-group">
                                    Answer:
                                    <input type="text" name="replay" class="form-control p-4" placeholder="Enter Replay" required/>
                                </div>
