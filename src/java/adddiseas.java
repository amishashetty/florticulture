 ...
 * @author sai ram
 */
public class adddiseas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            sta.executeUpdate("INSERT INTO `diseases` (`id`, `name`, `photo`, `solution`) VALUES (NULL, '"+name+"', '"+photo+"', '"+solution+"');");
            out.println("<script>alert('Diseas Added Succesfully')</script>");
            ...
            out.println("</html>");
                ...
                {
                    //out.println(e);
                     out.println("<script>alert('Error Adding Diseas')</script>");
                out.println("<meta http-equiv='refresh' content='0;diseases.jsp'/>");
                }
    }
