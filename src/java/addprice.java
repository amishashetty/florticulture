...
public class addprice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            sta.executeUpdate("INSERT INTO `price` (`id`, `date`, `flowerid`, `price`, `area`) VALUES (NULL, '"+date+"', '"+flowerid+"', '"+price+"', '"+area+"');");
            out.println("<script>alert('price Added Succesfully')</script>");
            ...
            out.println("</html>");
                ...
                {
                    //out.println(e);
                     out.println("<script>alert('Error Adding Price')</script>");
                out.println("<meta http-equiv='refresh' content='0;flower.jsp'/>");
                }
    }
