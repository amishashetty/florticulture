 ...
 * @author USER
 */
public class addfertilizer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            sta.executeUpdate("INSERT INTO `fertilizer` (`id`, `name`, `combination`, `uses`, `direction`) VALUES (NULL, '"+name+"', '"+combination+"', '"+uses+"', '"+directions+"');");
            out.println("<script>alert('Fertilizer Added Succesfully')</script>");
                out.println("<meta http-equiv='refresh' content='0;fertilizer.jsp'/>");
            out.println("</body>");
            out.println("</html>");
        }
        catch(Exception e)
                {
                    //out.println(e);
                     out.println("<script>alert('Error Adding Fertilizer')</script>");
                out.println("<meta http-equiv='refresh' content='0;fertilizer.jsp'/>");
                }
    }
