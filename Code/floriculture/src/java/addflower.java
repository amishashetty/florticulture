...
public class addflower extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            sta.executeUpdate("INSERT INTO `flowers` (`id`, `name`, `scientificname`, `photo`, `soil`, `medicine`, `growth`, `uses`, `fertilizer`, `weather`) VALUES (NULL, '"+name+"', '"+sname+"', '"+photo+"', '"+soil+"', '"+medicine+"', '"+growth+"', '"+uses+"', '"+fertilizer+"', '"+weather+"');");
