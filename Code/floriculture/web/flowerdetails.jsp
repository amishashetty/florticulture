        ...
        <div class="container py-5">
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            while(res.next())
            {
                ...
                out.println("<tr><td>"+name+"("+scientificname+")</td><td><img src='"+photo+"' style=\"width:100px;\"></td><td>Soil: "+soil+"<br>Growth: "+growth+"<br>Weather: "+weather+"</td><td>Medicine: "+medicine+"<br>Fertilizers: "+fertilizer+"<td>"+uses+"</d><td><a href='addprice.jsp?id="+id+"'><img src='img/rs.png' style=\"width:25px;\"></a></td></tr>");
